...
public class HumanPlayer implements Player {
    ...
    public void playTurn() {
        ...
        for (int i = 0; i < (int)this.possibleMove.getMoves().size(); i++) {
            if (this.lastMove.getX() == this.possibleMove.getMoves().elementAt(i).getX()
            && this.lastMove.getY() == this.possibleMove.getMoves().elementAt(i).getY()) {
    ...
    public boolean checkInput(String userInput) {
        ...
        System.out.println("string split into: " + input.length);
        if (input.length == 2 && Character.isDigit(input[0].charAt(0))
            ...
            for (int i = 0; i < this.possibleMove.getMoves().size(); i++) {
                ...
                if (tempCell.getX() == this.possibleMove.getMoves().elementAt(i).getX()
                        && tempCell.getY() == this.possibleMove.getMoves().elementAt(i).getY()) {
