...
public class GameFlow {
    ...
    public void lastPlayerMoveMsg(Player lastPlayer, boolean playerMoves) {
        if (playerMoves) {
            ...
            System.out.println("Player " + lastPlayer.getType() + " had no moves\n");
        }
    }
    ...
    public void showScores() {
        ...
        if (this.game.getP1Score() > this.game.getP2Score()) {
            System.out.println("Player " + this.game.getP1().getType() + " Won!");
        }
        if (this.game.getP2Score() > this.game.getP1Score()) {
            System.out.println("Player " + this.game.getP2().getType() + " Won!");
        }
        if (this.game.getP2Score() == this.game.getP1Score()) {
